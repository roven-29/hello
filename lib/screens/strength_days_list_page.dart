...
class StrengthDaysListPage extends StatefulWidget {
  final int totalDays;

  const StrengthDaysListPage({super.key, required this.totalDays});

  @override
  State<StrengthDaysListPage> createState() => _StrengthDaysListPageState();
}

class _StrengthDaysListPageState extends State<StrengthDaysListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('${widget.totalDays}-Day Program'),
      ),
      body: isLoading
  ...
  Widget _buildDayCard(
    ...
    return Card(
      ...
      child: InkWell(
        onTap: isAccessible
            ? () {
                context.go('/strength-workout/${widget.totalDays}/$day');
              }
            : null,
        child: Container(
