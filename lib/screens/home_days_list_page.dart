...
class HomeDaysListPage extends StatefulWidget {
  final int totalDays;

  const HomeDaysListPage({super.key, required this.totalDays});

  @override
  State<HomeDaysListPage> createState() => _HomeDaysListPageState();
}

class _HomeDaysListPageState extends State<HomeDaysListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('${widget.totalDays}-Day Home Workout Program'),
      ),
      body: isLoading
  ...
  Widget _buildDayCard(
    ...
    return Card(
      ...
      child: InkWell(
        onTap: isAccessible
            ? () {
                context.go('/home-workout/${widget.totalDays}/$day');
              }
            : null,
        child: Container(
