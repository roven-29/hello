...
class StrengthPlanSelectionPage extends StatelessWidget {
  const StrengthPlanSelectionPage({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPlanCard(
              ...
              description: 'Perfect for beginners to build a habit',
            ),
            const SizedBox(height: 20),
            _buildPlanCard(
              context,
              days: 30,
              title: '30 Days Transform',
